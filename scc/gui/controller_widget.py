...
GYROS = [GYRO]
PRESSABLE = [SCButtons.LPAD, SCButtons.RPAD, SCButtons.STICKPRESS, SCButtons.CPADPRESS, SCButtons.RSTICKPRESS]
...
class ControllerWidget:
	...
	def set_icon_file(self, path):
		...
		self.icon.set_from_pixbuf(SVGWidget.render_svg_file(path, inverted, brightness))
